...
def _ultrasound_likeness_check(image_bytes):
    """
    Lightweight gate to reduce false 'reliable' flags on non-ultrasound images.
    This is NOT a diagnosis; it checks whether the upload looks like a typical ultrasound frame.
    ...
    try:
        ...
        # Saturation proxy: std between channels (ultrasound tends to be grayscale-ish)
        ...
        # Ultrasound frames usually retain a meaningful dark field
        ...
        # Fail closed for validation messaging — do not claim "confirmed ultrasound"
        return {
            "ok": False,
            "error": repr(e),
